...
const Clips = ({ imgsrc, clip }) => {
  return (
    <>
      <div className="relative h-28 w-32 overflow-hidden rounded-xl group cursor-pointer transition-all duration-300 lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20 sm:h-14">
        <img
          src={imgsrc}
          alt="img/clip"
